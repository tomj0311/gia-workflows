...
- **Practice**: **CRITICAL** Define a single main function that returns the desired output variables, and call it at the end of the script. This ensures that intermediate variables and imports do not leak into the global context.
